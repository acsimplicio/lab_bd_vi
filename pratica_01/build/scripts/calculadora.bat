...
set CLASSPATH=%APP_HOME%\lib\calculadora.jar


@rem Execute calculadora
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CALCULADORA_OPTS%  -classpath "%CLASSPATH%" app.Application %*
...
if  not "" == "%CALCULADORA_EXIT_CONSOLE%" exit 1
exit /b 1
